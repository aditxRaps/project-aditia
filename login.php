...
$pesanHari = [
    ...
    "Sunday" => "Selamat Hari Minggu!  hari liburmu ☀️"
];
...
<head>
    ...
    <style>
        body {
            background: linear-gradient(135deg, #4a90e2,rgb(37, 219, 119));
...
<body>
    <div class="container mt-4">
        ...
        <div class="container description">
            ...
            <p>Buat daftar tugasmu dan kelola lebih efisien.</p>
        </div>
